...
contains
   subroutine test_alpha_soave
      ...
      call assert(allclose(a, aval, absolute_tolerance), "AlphaSoave")
      call assert(allclose(dadt, davaldt, absolute_tolerance), "AlphaSoave dT")
      call assert(allclose(dadt2, davaldt2, absolute_tolerance), "AlphaSoave dT2")
   ...
   subroutine test_alpha_RKPR
      ...
      call assert(allclose(a, aval, absolute_tolerance), "AlphaRKPR")
      call assert(allclose(dadt, davaldt, absolute_tolerance), "AlphaRKPR dT")
      call assert(allclose(dadt2, davaldt2, absolute_tolerance), "AlphaRKPR dT2")
   end subroutine test_alpha_RKPR
end program test_cubic_alphas
