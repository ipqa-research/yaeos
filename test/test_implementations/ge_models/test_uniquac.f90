...
contains
   ...
   subroutine test_uniquac_cons_mix(error)
      ...
      A = reshape(&
         [0.0_pr, -75.46_pr, -60.15_pr, &
         120.20_pr, 0.0_pr, 44.22_pr, &
         120.20_pr, 33.21_pr, 0.0_pr], [nc,nc])

      B = reshape(&
         [0.0_pr, -0.10062_pr, 0.2566_pr, &
         0.44835_pr, 0.0_pr, -0.01325_pr, &
         0.44835_pr, 0.124_pr, 0.0_pr], [nc,nc])

      C = reshape(&
         [0.0_pr, -0.0008052_pr, 0.00021_pr, &
         0.0004704_pr, 0.0_pr, -0.00033_pr, &
         0.0004704_pr, -0.000247_pr, 0.0_pr], [nc,nc])

      D = reshape(&
         [0.0_pr, -0.001_pr, 0.0002_pr, &
         -0.001_pr, 0.0_pr, 0.0002_pr, &
         -0.001_pr, 0.0002_pr, 0.0_pr], [nc,nc])

      E = reshape(&
         [0.0_pr, -0.00001_pr, 0.00001_pr, &
         -0.00001_pr, 0.0_pr, 0.00001_pr, &
         -0.00001_pr, 0.00001_pr, 0.0_pr], [nc,nc])
   ...
   subroutine test_against_gmehling(error)
      ...
      b = reshape([0.0_pr, b12, b21, 0.0_pr], [nc, nc])
