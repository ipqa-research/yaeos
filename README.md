...
The latest comprehensive API documentation for the `main` branch can be found:
   - **[Complete Fortran API Documentation](https://ipqa-research.github.io/yaeos/)** - Full API reference with examples
   - **[User Guide and Tutorials](https://ipqa-research.github.io/yaeos/page/usage/index.html)** - Getting started and usage examples
   - **[Installation Guide](https://ipqa-research.github.io/yaeos/page/installation/index.html)** - Complete setup instructions
   - **[API Reference](https://ipqa-research.github.io/yaeos/page/api-reference/index.html)** - Comprehensive API overview
   - **[Examples and Tutorials](https://ipqa-research.github.io/yaeos/page/examples/index.html)** - Practical examples and applications
   - **[Troubleshooting Guide](https://ipqa-research.github.io/yaeos/page/troubleshooting/index.html)** - FAQ and common issues
   - **[Python API Documentation](https://ipqa-research.github.io/yaeos/page/python-api/index.html)** - Python interface documentation

The Fortran API documentation is generated using [FORD](https://github.com/Fortran-FOSS-Programmers/ford) and includes:
- Complete module and procedure documentation
...
The Python API documentation is generated using [Sphinx](https://github.com/sphinx-doc/sphinx).
