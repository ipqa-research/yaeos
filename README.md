...
derivatives and derivatives obtained with automatic differentiation.

The main focus of `yaeos` is giving robusts algorithms for calculations of
diagrams and phase-equilibria properties, with a good framework for the user 
to add new models.
...
##  Dependencies
`yaeos` needs to have `lapack` in your system.
...
`example/adiff/adiff_pr76.f90`. Or in the documentation pages. Which can
serve as an example of how to implement models.
